...
# Lista para almacenar el estado del mapa en cada paso
map_history = []
class SoM:
    ...
    def __init__(self, method='random', input_dim=3, data=None,total_nodes=100):
        ...
        if data is not None:
            ...
            raise ValueError("Se debe los datos para el método 'pca'.")
    ...
    def train(self, train_data, learn_rate=0.1, radius_sq=1, lr_decay=0.1, radius_decay=0.1, epochs=10,
            ...
            save=False):         # Guardar los valores para una animación
            ...
            if update == 'batchmap':
                ...
                if update == 'minibatch':
                    ...
                    for batch in batches:
                        self.update_weights_batch(batch, radius_sq, step=step,save=save)
